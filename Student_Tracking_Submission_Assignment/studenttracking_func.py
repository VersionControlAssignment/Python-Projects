...
def first_run(self):
    ...
    with conn:
        ...
        if count < 1:
            cur.execute("""INSERT INTO tbl_student_tracking (col_fname,col_lname,col_fullname,col_phone,col_email,col_currentcourse) VALUES (?,?,?,?,?)""", ('Utopia','Show','Utopia Show','123-456-7','utopiashow@email.com'))
            conn.commit()
    conn.close()
